...
export function FAQSection({ t }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_15%_10%,rgba(0,0,0,0.08),transparent_30%),radial-gradient(circle_at_85%_0%,rgba(0,0,0,0.06),transparent_32%),linear-gradient(180deg,#f9fafb,#ffffff)] py-24">
